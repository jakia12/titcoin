        ...
        updateSlides: function() {
            ...
            for (let i = 0; i < m; i += 1) {
                ...
                if (
                    ((z = 0),
                        p[i] && (r = p[i]),
                        L && e.grid.updateSlide(i, r, m, t), !p[i] || "none" !== w(r, "display"))
                ) {
            ...
            function M(e) {
                if (!E(e) ||
                    !(function(e) {
                        ...
                        return (!!e.target.matches(s) || [...t.el.querySelectorAll(s)].filter((t) => t.contains(e.target))
                            .length > 0
                        );
                    })(e)
                )
...
!(function(e, t) {
    ...
    function ie(e) {
        ...
        e.settings.share &&
            ...
            m.length < 2 && ((f = !1), (h = !1)),
            (T = m[l + 1]),
            (j = m[l - 1]), !T && f && (T = m[0]), !j && f && (j = m[m.length - 1]),
            m.length >= 1 ?
    ...
    function de(l) {
        return (!(document.body.classList.contains("vbox-open") || !l) &&
            (l.settings.onPreOpen &&
                ...
                l.settings.onPreOpen(l), !!l.settings.onPreOpen &&
                (U(l),
            ...
            return (
                (s.typeHtmlChars = function(t, s, e) {
                    ...
                    if ("<" === n || "&" === n) {
                        var i;
                        for (
                            i = "<" === n ? ">" : ";"; t.substring(s + 1).charAt(0) !== i && !(1 + ++s > t.length);
                ...
                (s.backSpaceHtmlChars = function(t, s, e) {
                    ...
                    if (">" === n || ";" === n) {
                        var i;
                        for (
                            i = ">" === n ? "<" : "&"; t.substring(s - 1).charAt(0) !== i && !(--s < 0);
